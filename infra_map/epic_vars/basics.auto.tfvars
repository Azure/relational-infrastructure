deployment_prefix  = "epcc04" # Provide a unique deployment name. 3-10 alphanumeric characters.
include_label_tags = true # Maps Azure resources to the underlying infrastructure model.
                          # Recommended for debugging purposes.

locations = {
  production = "canadacentral" # All Epic resources will be deployed to this region.
